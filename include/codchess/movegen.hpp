...
namespace movegen {
    ...
    [[nodiscard]] std::vector<Move> PseudoLegalCaptures(const Board &board) noexcept;
    ...
    [[maybe_unused]] [[nodiscard]] std::vector<Move> Legal(const Board &board) noexcept;
    ...
    [[maybe_unused]] [[nodiscard]] std::vector<Move> LegalCaptures(const Board &board) noexcept;
