...
static boost::signals2::signal<void()> receive_uci;
/// @brief Receive 'stop' command signal.
static boost::signals2::signal<void()> receive_stop;
/// @brief Receive 'quit' command signal.
static boost::signals2::signal<void()> receive_quit;
/// @brief Receive 'isready' command signal.
static boost::signals2::signal<void()> receive_is_ready;
/// @brief Receive 'ponderhit' command signal.
static boost::signals2::signal<void()> receive_ponder_hit;
/// @brief Receive 'ucinewgame' command signal.
static boost::signals2::signal<void()> receive_uci_new_game;
//// @brief Receive 'debug' command signal.
static boost::signals2::signal<void(bool on)> receive_debug;
/// @brief Receive 'setoption' command signal.
static boost::signals2::signal<void(const std::string &name,
                                    const std::string &value)>
    receive_set_option;
//// @brief Receive 'register' command signal.
static boost::signals2::signal<void(bool later, const std::string &name,
                                    const std::size_t &code)>
    receive_register;
//// @brief Receive 'position' command signal.
static boost::signals2::signal<void(const std::string &fen,
...
inline void
SendId(const std::string &name = "", const std::string &author = "") {
...
/// @param ponder
inline void
SendBestMove(const std::string &move, const bool ponder = false) {
...
inline void
SendCopyProtection(const State state) {
...
/// @param state The state.
inline void
SendRegistration(const State state) {
...
inline void
SendOptionCheckBox(const std::string &name, const bool initial = true) {
...
/// @param initial The initial value.
inline void
SendOptionSpinWheel(const std::string &name, const std::size_t &initial,
...
inline void
SendOptionComboBox(const std::string &name, const std::string &initial,
...
/// @param name The name.
inline void
SendOptionButton(const std::string &name) {
...
/// @param name The name.
inline void
SendOptionString(const std::string &name, const std::string &initial) {
    std::cout << "option name " << name << " type string default " << initial
              << std::endl;
}
...
inline void
send_option_hash(const std::size_t &initial, const std::size_t &minimum,
...
/// @param initial The initial value.
inline void
SendOptionNalimovPath(const std::string &initial) {
...
/// @param maximum The maximum value.
inline void
SendOptionNalimovCache(const std::size_t &initial, const std::size_t &minimum,
                       const std::size_t &maximum) {
...
/// @param initial The initial value.
inline void
SendOptionPonder(const bool initial = true) {
...
/// @param initial The initial value.
inline void
SendOptionOwnBook(const bool initial = true) {
...
/// @param maximum The maximum value.
inline void
SendOptionMultiPrincipleVariation(const std::size_t &initial,
...
/// @param initial The initial value.
inline void
SendOptionUciShowCurrentLine(const bool initial = true) {
...
/// @param initial The initial value.
inline void
SendOptionUciShowRefutations(const bool initial = true) {
...
/// @param initial The initial value.
inline void
SendOptionUciLimitStrength(const bool initial = true) {
...
/// @param maximum The maximum value.
inline void
SendOptionUciElo(const std::size_t &initial, const std::size_t &minimum,
                 const std::size_t &maximum) {
...
/// @param initial The initial value.
inline void
SendOptionUciAnalyseMode(bool const initial = true) {
...
/// @param initial The initial value.
inline void
SendOptionUciOpponent(const std::string &initial) {
...
/// @param initial The initial value.
inline void
SendOptionUciAbout(const std::string &initial) {
...
/// @param initial The initial value.
inline void
SendOptionUciSetPositionCentipawns(const std::string &initial) {
    SendOptionString("UCI_SetPositionValue", initial);
}

/// @brief Sends an illegal move error.
inline void
SendErrorIllegalMove() {
