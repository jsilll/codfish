...
static constexpr int EG_KING_TABLE[64] = {-74, -35, -18, -18, -11, 15,  4,   -17, -12, 17, 14,
...
static constexpr int PIECE_SCORES[] = {100, 280, 320, 479, 929, 60000};

void
init() {
    for (int sq = A1; sq < N_SQUARES; sq++) {
        Square sq_flipped = FlipSquare(static_cast<Square>(sq));
