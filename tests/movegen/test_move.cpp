...
TEST_CASE("Test Moves")
{
    SECTION("Impossible Move")
    {
        ...
        REQUIRE(move.get_piece() == PAWN);
        REQUIRE(move.get_captured_piece() == QUEEN);
        REQUIRE(move.get_promoted_piece() == QUEEN);
    ...
    SECTION("Pawn Takes King")
    {
        ...
        REQUIRE(move.get_piece() == PAWN);
        REQUIRE(move.get_captured_piece() == KING);
        REQUIRE(move.get_promoted_piece() == EMPTY_PIECE);
    ...
    SECTION("Pawn Takes Rook")
    {
        ...
        REQUIRE(move.get_to_square() == 1);
        REQUIRE(move.get_piece() == PAWN);
        REQUIRE(move.get_captured_piece() == ROOK);
        REQUIRE(move.get_promoted_piece() == EMPTY_PIECE);
        REQUIRE(move.is_promotion() == false);
        REQUIRE(move.is_double_push() == false);
        REQUIRE(move.is_en_passant() == false);
    ...
    SECTION("Pawn Takes Bishop")
    {
        ...
        REQUIRE(move.get_to_square() == 1);
        REQUIRE(move.get_piece() == PAWN);
        REQUIRE(move.get_captured_piece() == BISHOP);
        REQUIRE(move.get_promoted_piece() == EMPTY_PIECE);
        REQUIRE(move.is_promotion() == false);
        REQUIRE(move.is_double_push() == false);
        REQUIRE(move.is_en_passant() == false);
    ...
    SECTION("Pawn Takes Knight")
    {
        ...
        REQUIRE(move.get_to_square() == 1);
        REQUIRE(move.get_piece() == PAWN);
        REQUIRE(move.get_captured_piece() == KNIGHT);
        REQUIRE(move.get_promoted_piece() == EMPTY_PIECE);
        REQUIRE(move.is_promotion() == false);
        REQUIRE(move.is_double_push() == false);
        REQUIRE(move.is_en_passant() == false);
    ...
    SECTION("Pawn Takes Pawn")
    {
        ...
        REQUIRE(move.get_to_square() == 1);
        REQUIRE(move.get_piece() == PAWN);
        REQUIRE(move.get_captured_piece() == PAWN);
        REQUIRE(move.is_promotion() == false);
        REQUIRE(move.is_double_push() == false);
        REQUIRE(move.is_en_passant() == false);
        REQUIRE(move.is_castle() == false);
