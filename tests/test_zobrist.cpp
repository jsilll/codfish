...
//     REQUIRE(board.hash_key() == zobrist::generate_hash_key(board));
//   }
//
...
//     REQUIRE(board.hash_key() == state.hash_key);
//   }
//
...
//   {
//     board.SetFromFen("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q2/PPPBBP1p/R3K1P1", "b", "KQkq", "-", "0", "1");
...
//   {
//     board.SetFromFen("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q2/PPPBBP1p/R3K1PR", "b", "KQkq", "-", "0", "1");
