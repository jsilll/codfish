...
void cli::InfoCommand::execute([[maybe_unused]] std::vector<std::string> &args)
{
    ...
    bitboard::print(_board.pieces(WHITE, PAWN));
    std::cout << "WHITE, KNIGHT" << std::endl;
    bitboard::print(_board.pieces(WHITE, KNIGHT));
    std::cout << "WHITE, BISHOP" << std::endl;
    bitboard::print(_board.pieces(WHITE, BISHOP));
    std::cout << "WHITE, ROOK" << std::endl;
    bitboard::print(_board.pieces(WHITE, ROOK));
    std::cout << "WHITE, QUEEN" << std::endl;
    bitboard::print(_board.pieces(WHITE, QUEEN));
    std::cout << "WHITE, KING" << std::endl;
    bitboard::print(_board.pieces(WHITE, KING));
    std::cout << "BLACK, PAWN" << std::endl;
    bitboard::print(_board.pieces(BLACK, PAWN));
    std::cout << "BLACK, KNIGHT" << std::endl;
    bitboard::print(_board.pieces(BLACK, KNIGHT));
    std::cout << "BLACK, BISHOP" << std::endl;
    bitboard::print(_board.pieces(BLACK, BISHOP));
    std::cout << "BLACK, ROOK" << std::endl;
    bitboard::print(_board.pieces(BLACK, ROOK));
    std::cout << "BLACK, QUEEN" << std::endl;
    bitboard::print(_board.pieces(BLACK, QUEEN));
    std::cout << "BLACK, KING" << std::endl;
    bitboard::print(_board.pieces(BLACK, KING));
