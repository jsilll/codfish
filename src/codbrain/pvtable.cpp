...
std::vector<Move>
PVTable::get_pv_from_depth(int start_depth) {
    std::vector<Move> res;
...
void
PVTable::add(Move const move, int depth) {
...
void
PVTable::add_pv_from_depth(std::vector<Move> moves, int starting_depth) {
