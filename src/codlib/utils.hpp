...
namespace utils {
    ...
    constexpr bitboard::Bitboard MASK_RANK[] = {0xFF,
                                                0xFF00,
                                                0xFF0000,
                                                0xFF000000,
                                                0xFF00000000,
    ...
    constexpr bitboard::Bitboard MASK_FILE[] = {0x0101010101010101,
                                                0x202020202020202,
                                                0x404040404040404,
                                                0x808080808080808,
                                                0x1010101010101010,
    ...
    constexpr bitboard::Bitboard MASK_CLEAR_RANK[] = {0xFFFFFFFFFFFFFF00,
                                                      0xFFFFFFFFFFFF00FF,
                                                      0xFFFFFFFFFF00FFFF,
    ...
    constexpr bitboard::Bitboard MASK_CLEAR_FILE[] = {0xFEFEFEFEFEFEFEFE,
                                                      0xFDFDFDFDFDFDFDFD,
                                                      0xFBFBFBFBFBFBFBFB,
                                                      0xF7F7F7F7F7F7F7F7,
                                                      0xEFEFEFEFEFEFEFEF,
