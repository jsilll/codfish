...
namespace utils {
    ...
    constexpr bitboard::Bitboard MASK_RANK[] = {0xFF, 0xFF00, 0xFF0000, 0xFF000000, 0xFF00000000, 0xFF0000000000,
                                                0xFF000000000000, 0xFF00000000000000};

    /// @brief Bitboard masks for each file
    constexpr bitboard::Bitboard MASK_FILE[] = {0x0101010101010101, 0x202020202020202, 0x404040404040404,
                                                0x808080808080808, 0x1010101010101010, 0x2020202020202020,
                                                0x4040404040404040, 0x8080808080808080};

    /// @brief Bitboard masks for clearing each rank
    constexpr bitboard::Bitboard MASK_CLEAR_RANK[] = {0xFFFFFFFFFFFFFF00, 0xFFFFFFFFFFFF00FF, 0xFFFFFFFFFF00FFFF,
    ...
    constexpr bitboard::Bitboard MASK_CLEAR_FILE[] = {0xFEFEFEFEFEFEFEFE, 0xFDFDFDFDFDFDFDFD, 0xFBFBFBFBFBFBFBFB,
    ...
    constexpr bitboard::Bitboard SQUARE_BB[N_SQUARES] = {0x1ULL, 0x2ULL, 0x4ULL, 0x8ULL, 0x10ULL, 0x20ULL, 0x40ULL,
                                                         0x80ULL, 0x100ULL, 0x200ULL, 0x400ULL, 0x800ULL, 0x1000ULL,
                                                         0x2000ULL, 0x4000ULL, 0x8000ULL, 0x10000ULL, 0x20000ULL,
                                                         0x40000ULL, 0x80000ULL, 0x100000ULL, 0x200000ULL, 0x400000ULL,
                                                         0x800000ULL, 0x1000000ULL, 0x2000000ULL, 0x4000000ULL,
                                                         0x8000000ULL, 0x10000000ULL, 0x20000000ULL, 0x40000000ULL,
                                                         0x80000000ULL, 0x100000000ULL, 0x200000000ULL, 0x400000000ULL,
                                                         0x800000000ULL, 0x1000000000ULL, 0x2000000000ULL,
                                                         0x4000000000ULL, 0x8000000000ULL, 0x10000000000ULL,
                                                         ...
                                                         0x100000000000000ULL, 0x200000000000000ULL,
    ...
    // -- Rank, File and Square Manipulation --
