...
/// @brief Bitboard constant for bit manipulation
    constexpr Bitboard kONE{1};

/// @brief Bitboard constant for bit manipulation
    constexpr Bitboard kZERO{0};

// -- Bitboard manipulation functions --

/// @brief Pops the last bit in a bitboard
/// @param bb The bitboard
    constexpr void pop_last_bit(Bitboard &bb) noexcept { bb &= bb - kONE; }

/// @brief Sets a bit in a bitboard
/// @param bb The bitboard
/// @param sq The square
    constexpr void set_bit(Bitboard &bb, Square sq) noexcept { bb |= (kONE << sq); }

/// @brief Pops a bit in a bitboard
/// @param bn The bitboard
/// @param sq The square
    constexpr void pop_bit(Bitboard &bb, Square sq) noexcept { bb &= ~(kONE << sq); }

/// @brief Gets a bit in a bitboard
/// @param bb The bitboard
/// @param sq The square
/// @return Whether the bit is set or not
    [[nodiscard]] constexpr bool get_bit(const Bitboard bb, const Square sq) noexcept { return ((bb >> sq) & kONE); }
...
/// @param bb The bitboard
/// @return The shifted bitboard
    [[nodiscard]] constexpr Bitboard east_one(const Bitboard bb) noexcept { return (bb << Direction::EAST) & 0xFEFEFEFEFEFEFEFE; }

/// @brief Shifts a bitboard one square west
/// @param bb The bitboard
/// @return The shifted bitboard
    [[nodiscard]] constexpr Bitboard west_one(const Bitboard bb) noexcept { return (bb >> Direction::EAST) & 0x7F7F7F7F7F7F7F7F; }
