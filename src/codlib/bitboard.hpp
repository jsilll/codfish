...
/// @param bb The bitboard
/// @return The shifted bitboard
    [[nodiscard]] constexpr u64 no_ea_one(const u64 bb) noexcept {
...
/// @param bb The bitboard
/// @return The shifted bitboard
    [[nodiscard]] constexpr u64 no_we_one(const u64 bb) noexcept {
...
/// @param bb The bitboard
/// @return The shifted bitboard
    [[nodiscard]] constexpr u64 so_ea_one(const u64 bb) noexcept {
...
/// @param bb The bitboard
/// @return The shifted bitboard
    [[nodiscard]] constexpr u64 so_we_one(const u64 bb) noexcept {
