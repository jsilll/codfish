...
constexpr Bitboard MAGICS_BISHOP[N_SQUARES] = {0x40040844404084ULL,
                                               0x2004208a004208ULL,
                                               0x10190041080202ULL,
...
constexpr Bitboard MAGICS_ROOK[N_SQUARES] = {0x8a80104000800020ULL,
...
[[nodiscard]] constexpr Bitboard mask_bishop_attack_rays(const Square sq) noexcept
{
  ...
  Bitboard attacks = bitboard::kZERO;
