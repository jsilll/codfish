...
namespace attacks
{
    ...
    [[nodiscard]] constexpr u64 mask_white_pawn_single_pushes(u64 wpawns, u64 empty) noexcept { return bitboard::nort_one(wpawns) & empty; }

    /// @brief Returns a bitboard of all black pawn single pushes.
    /// @param bpawns A bitboard of black pawns.
    /// @param empty A bitboard of empty squares.
    /// @return A bitboard of all black pawn single pushes.
    [[nodiscard]] constexpr u64 mask_black_pawn_single_pushes(u64 bpawns, u64 empty) noexcept { return bitboard::sout_one(bpawns) & empty; }

    /// @brief Returns a bitboard of all white pawn double pushes.
    /// @param wpawns A bitboard of white pawns.
    /// @param empty A bitboard of empty squares.
    /// @return A bitboard of all white pawn double pushes.
    [[nodiscard]] constexpr u64 mask_white_pawn_double_pushes(u64 wpawns, u64 empty) noexcept
    {
    ...
    [[nodiscard]] constexpr u64 mask_black_pawn_double_pushes(u64 bpawns, u64 empty) noexcept
    {
    ...
    [[nodiscard]] constexpr u64 mask_white_pawn_any_attacks(u64 wpawns) noexcept { return mask_white_pawn_east_attacks(wpawns) | mask_white_pawn_west_attacks(wpawns); }

    /// @brief Returns a bitboard of all the black pawn attacks.
    /// @param bpawns A bitboard of black pawns.
    /// @return A bitboard of all the black pawn attacks.
    [[nodiscard]] constexpr u64 mask_black_pawn_any_attacks(u64 bpawns) noexcept { return mask_black_pawn_east_attacks(bpawns) | mask_black_pawn_west_attacks(bpawns); }
    ...
    [[nodiscard]] constexpr u64 mask_bishop_xray_attacks(Square sq, u64 block) noexcept
    {
    ...
    [[nodiscard]] constexpr u64 mask_rook_xray_attacks(Square sq, u64 block) noexcept
    {
        u64 attacks = bitboard::kZERO;
        Rank rank = utils::get_rank(sq);
        File file = utils::get_file(sq);
